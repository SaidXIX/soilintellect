...
const PasswordReset = () => {
  ...
  return (
    ...
    >
      {!error && (
        <Stack spacing={10} mx={'auto'} minW={'30%'} py={12} px={6}>
          <Image
      ...
      {error && (
        ...
        >
          ...
          <Text
            ...
            textAlign='center'
          >
            {t('signup.verificationLinkExpiredMessage')}
          </Text>
          <Button
            _hover={{
              backgroundColor: useColorModeValue('lightMode.primary', 'orange')
            }}
            color={useColorModeValue('white', 'black')}
            backgroundColor={useColorModeValue(
              'blue.600',
